        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    AcademicProgramProgramID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => x.StudentID);
                    table.ForeignKey(
                        name: "FK_Students_AcademicPrograms_AcademicProgramProgramID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sections_Faculty_FacultyID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryItemItemID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryIssues", x => x.IssueID);
                    table.ForeignKey(
                        name: "FK_LibraryIssues_LibraryItems_LibraryItemItemID",
                        column: x => x.LibraryItemItemID,
                        principalTable: "LibraryItems",
                        principalColumn: "ItemID");
                    table.ForeignKey(
                        name: "FK_LibraryIssues_Students_StudentID",
                        column: x => x.StudentID,
                        principalTable: "Students",
                        principalColumn: "StudentID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LibraryIssues_LibraryItemItemID",
                table: "LibraryIssues",
                column: "LibraryItemItemID");

            migrationBuilder.CreateIndex(
                name: "IX_LibraryIssues_StudentID",
                table: "LibraryIssues",
                column: "StudentID");
